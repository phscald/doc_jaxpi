...
def evaluate(config: ml_collections.ConfigDict, workdir: str):
    ...
    ax.set_yticks([])
    plt.tight_layout()
    plt.savefig(f'field_ffmlp_s_{mu}_{time}.jpg', format='jpg')
    ...
    ax.set_yticks([])  
    plt.tight_layout()
    plt.savefig(f'field_ffmlp_u_{mu}_{time}.jpg', format='jpg')
    ...
    ax.set_yticks([])
    plt.tight_layout()
    plt.savefig(f'field_ffmlp_v_{mu}_{time}.jpg', format='jpg') 
    ...
    ax.set_yticks([])
    plt.tight_layout()
    plt.savefig(f'field_ffmlp_p_{mu}_{time}.jpg', format='jpg')
