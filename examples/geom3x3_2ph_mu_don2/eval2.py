...
def evaluate(config: ml_collections.ConfigDict, workdir: str):
    ...
    t1 = 2500
    # t_fem: [ 200.  400.  600.  800. 1000. 1200. 1400. 1600. 1800. 2000. 2200. 2400. 2600. 2800. 3000.]
    ...
    if config.nondim == True:
        ...
        print(f'u_fem - shape: {u_fem.shape}')
        print(f'v_fem - shape: {v_fem.shape}')
        print(f'p_fem - shape: {p_fem.shape}')
        print(f's_fem - shape: {s_fem.shape}')
        print(f't_fem: {t_fem}')
        # print(dada0)
