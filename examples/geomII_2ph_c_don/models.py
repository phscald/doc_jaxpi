...
class NavierStokes2D(ForwardBVP):
    ...
    def neural_net(self, params, x, y, cylX, cylY):
        # x = x / self.L  # rescale x into [0, 1]
        # y = y / self.W  # rescale y into [0, 1]
        z = jnp.stack([x, y])
        z1 = jnp.stack([cylX, cylY])
    ...
    def u_net(self, params, x, y, cylX, cylY):
        u, _, _ = self.neural_net(params, x, y, cylX, cylY)
        return u

    def v_net(self, params, x, y, cylX, cylY):
        _, v, _ = self.neural_net(params, x, y, cylX, cylY)
        return v

    def p_net(self, params, x, y, cylX, cylY):
        _, _, p = self.neural_net(params, x, y, cylX, cylY)
        return p

    def r_net(self, params, x, y, cylX, cylY):
        u, v, p = self.neural_net(params, x, y, cylX, cylY)

        (u_x, u_y), (v_x, v_y), (p_x, p_y) = jacrev(self.neural_net, argnums=(1, 2))(params, x, y, cylX, cylY)

        u_hessian = hessian(self.u_net, argnums=(1, 2))(params, x, y, cylX, cylY)
        v_hessian = hessian(self.v_net, argnums=(1, 2))(params, x, y, cylX, cylY)
    ...
    def ru_net(self, params, x, y, cylX, cylY):
        ru, _, _, _ = self.r_net(params, x, y, cylX, cylY)
        return ru

    def rv_net(self, params, x, y, cylX, cylY):
        _, rv, _, _ = self.r_net(params, x, y, cylX, cylY)
        return rv

    def rc_net(self, params, x, y, cylX, cylY):
        _, _, rc, _ = self.r_net(params, x, y, cylX, cylY)
        return rc

    # def u_out_net(self, params, x, y, cylX, cylY):
    #     _, _, _, u_out, _ = self.r_net(params, x, y, cylX, cylY)
    #     return u_out

    def v_out_net(self, params, x, y, cylX, cylY):
        _, _, _, v_out = self.r_net(params, x, y, cylX, cylY)
        return v_out
