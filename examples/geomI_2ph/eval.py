...
def evaluate(config: ml_collections.ConfigDict, workdir: str):
    ...
    plt.subplot(4, 1, 1)
    plt.scatter(x, y, s=1, c=u_pred[-1], cmap="jet")#, levels=100)
    plt.colorbar()
    plt.xlabel("x")
    plt.ylabel("y")
    ...
    plt.subplot(4, 1, 2)
    plt.scatter(x, y, s=1, c=v_pred[-1], cmap="jet")#, levels=100)
    plt.colorbar()
    plt.xlabel("x")
    plt.ylabel("y")
    ...
    plt.subplot(4, 1, 3)
    plt.scatter(x, y, s=1, c=p_pred[-1], cmap="jet")#, levels=100)
    plt.colorbar()
    plt.xlabel("x")
    plt.ylabel("y")
    ...
    plt.subplot(4, 1, 4)
    plt.scatter(x, y, s=1, c=s_pred[-1], cmap="jet")#, levels=100)
    plt.colorbar()
    plt.xlabel("x")
    plt.ylabel("y")
    ...
    save_path = os.path.join(save_dir, "ns_geomI.png")
