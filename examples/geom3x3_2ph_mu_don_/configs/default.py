...
def get_config():
    ...
    div = 2
    training.inflow_batch_size = 64#256#int(2048/div)
    training.outflow_batch_size = 64#256#int(2048/div)
    training.noslip_batch_size = 256#512#int(2048/div)
    training.ic_batch_size = 256#512#int(2048/div)
    training.res_batch_size = 1024+128#512 #int(2*2048/div)
